...
-- --------------------------------------------------------
-- Table structure for table `tblbooksonsale`
--

CREATE TABLE `tblbooksonsale` (
  `id` int(11) NOT NULL,
  `BookName` varchar(255) DEFAULT NULL,
  `CatId` int(11) DEFAULT NULL,
  `AuthorId` int(11) DEFAULT NULL,
  `ISBNNumber` int(11) DEFAULT NULL,
  `BookQuantity` int(11) DEFAULT 1,
...
--
-- Dumping data for table `tblbooksonsale`
--

INSERT INTO `tblbooksonsale` (`id`, `BookName`, `CatId`, `AuthorId`, `ISBNNumber`, `BookQuantity`, `BookPrice`, `RegDate`, `UpdationDate`) VALUES
(1, 'PHP And MySql programming', 5, 1, 12123, 20, 7000, '2017-07-08 20:04:55', '2017-07-15 05:54:41'),
(2, 'Java for Dummies', 4, 2, 12090, 2, 800, '2017-07-08 20:04:55', '2017-07-15 05:54:41'),
(3, 'Advanced Calculus', 6, 3, 65456, 5, 5300, '2017-07-08 20:04:55', '2017-07-15 05:54:41'),
(4, 'History and Government', 7, 4, 22209292, 26, 9500, '2017-07-08 20:04:55', '2017-07-15 05:54:41'),
(5, 'The SUbtle Art of Not Giving a Fuck', 4, 5, 503, 3, 5900, '2017-07-08 20:04:55', '2017-07-15 05:54:41'),
(6, 'physics', 6, 9, 1111, 3, 1200, '2017-07-08 20:17:31', '2017-07-15 06:13:17');
...
CREATE TABLE `tblPurchaseItems` (
  `id` int(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
  `BookISBNNumber` varchar(120) DEFAULT NULL,
